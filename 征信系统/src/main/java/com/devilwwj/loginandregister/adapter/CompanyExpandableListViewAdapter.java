package com.devilwwj.loginandregister.adapter;
...
public class CompanyExpandableListViewAdapter extends BaseExpandableListAdapter implements
    ...
    public CompanyExpandableListViewAdapter(String[] groups, String[][] persons, Context context,
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild,
        ...
        if (convertView == null) {
            ...
            personHolder.tvPersonName = (TextView) convertView
                    .findViewById(R.id.tv_expand_item);
